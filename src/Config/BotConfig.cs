...
public class BotConfig {
    ...
    public class ConfigCommands {
        ...
        // badly named entry. renamed in v1
        ...
        public class ConfigNextTempStormCommand {
            ...
            [YamlMember(Order = 1, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "The color of the left strip of the embed.\nSupports any six-digit color hex value with leading \"#\".")]
            public Color Color = 0x008080;

            [YamlMember(Order = 2, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Title text for the embed.\n\"{0}\" is number of days.\n\"{1}\" is number of hours.\n\"{2}\" is number of minutes.")]
            public string Title = "Next temporal storm";

            [YamlMember(Order = 3, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Description text for the embed.\n\"{0}\" is number of days.\n\"{1}\" is number of hours.\n\"{2}\" is number of minutes.")]
            public string Description = "is in {0:day;days}, {1:hour;hours}, and {2:minute;minutes}";

            [YamlMember(Order = 4, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "The color of the left strip of the embed for an active storm.\nSupports any six-digit color hex value with leading \"#\".")]
            public Color ColorActive = 0x008080;

            [YamlMember(Order = 5, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Title text for the embed for an active storm.\n\"{0}\" is current storm strength.\n\"{1}\" is number of hours.\n\"{2}\" is number of minutes.")]
            public string TitleActive = "{0} temporal storm";

            [YamlMember(Order = 6, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Description text for the embed for an active storm.\n\"{0}\" is current storm strength.\n\"{1}\" is number of hours.\n\"{2}\" is number of minutes.")]
            public string DescriptionActive = "is still active for {1:hour;hours}, and {2:minute;minutes}";

            [YamlMember(Order = 7, Description = "An \"Ephemeral Message\" is a message sent by Clyde and other Discord bots.\nIt's a message that only you can see. These messages disappear when\nyou dismiss them, wait long enough, or restart Discord.")]
        ...
        public class ConfigPlayersCommand {
            ...
            [YamlMember(Order = 1, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "The help text describing the command's ping argument.")]
            ...
            [YamlMember(Order = 4, Description = "Display the player list in embed fields instead of a basic list.")]
            public bool PlayersFields = false;

            [YamlMember(Order = 5, Description = "If more than one player is online, display the fields side-by-side.")]
            public bool PlayersFieldsInline = true;

            [YamlMember(Order = 6, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the field title.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersFieldsTitle = "{0}";

            [YamlMember(Order = 7, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the field value.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersFieldsValue = "";

            [YamlMember(Order = 8, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the field title with ping.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersFieldsTitleWithPing = "{0}";

            [YamlMember(Order = 9, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the field value with ping.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersFieldsValueWithPing = "({1:0}ms)";

            [YamlMember(Order = 10, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player list.\n\"{0}\" holds one of the player list entries below.")]
            public string PlayersList = "{0}\n";

            [YamlMember(Order = 11, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the list.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersListEntry = "{0}\n";

            [YamlMember(Order = 12, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Format for the player entry in the list with ping.\n\"{0}\" is for player name.\n\"{1}\" is for ping.")]
            public string PlayersListEntryWithPing = "{0} ({1:0}ms)\n";

            [YamlMember(Order = 13, ScalarStyle = ScalarStyle.DoubleQuoted, Description = "Message to replace the fields/list if there are no players currently online.")]
            public string NoPlayersOnline = "*No players online*\n";

            [YamlMember(Order = 14, Description = "Show the formatted UTC time and date in the embed footer.")]
            public bool Timestamp = true;

            [YamlMember(Order = 15, Description = "An \"Ephemeral Message\" is a message sent by Clyde and other Discord bots.\nIt's a message that only you can see. These messages disappear when\nyou dismiss them, wait long enough, or restart Discord.")]
            public bool Ephemeral = true;
        }
        ...
        public class ConfigTimeCommand {
            ...
            [YamlMember(Order = 4, Description = "An \"Ephemeral Message\" is a message sent by Clyde and other Discord bots.\nIt's a message that only you can see. These messages disappear when\nyou dismiss them, wait long enough, or restart Discord.")]
            public bool Ephemeral = true;
        }
    }
